...
adata = sc.read("/data2/mukhtar_lab/tzhengz/new_attemp/0_preproc_dataset/Test_Arabidopsis/subset_Arabidopsis.h5ad")
...
adata_magic2.write("subset_Arabidopsis.h5ad", compression = True)
...
df.to_pickle("/data2/mukhtar_lab/tzhengz/new_attemp/0_preproc_dataset/Test_Arabidopsis/subset_Arabidopsis_mincell20_t1e-3.p")
print(df.sum(0))
