...
param_space = {
    ...
    'filterLenConv1' : hp.quniform('filterLenConv1', 2, 20, 1), #1-10
    ...
    },
    {
        ...
        'filterLenConv2' : hp.quniform('filterLenConv2', 2, 20, 1),
        ...
        },
        {
            ...
            'filterLenConv3' : hp.quniform('filterLenConv3', 2, 20, 1),
...
class CNN(BasicModule):
    def __init__(self, pooltype = 'maxpool', globalpoolsize=128,
                    numFiltersConv1=128, filterLenConv1=2, maxPool1=3,
                    isCBAM1=False, reduction_ratio1=16, 
                    isLayer2=True, numFiltersConv2=256, filterLenConv2=2, dilRate2=2, maxPool2=3,
                    isCBAM2=False, reduction_ratio2=16, 
                    isLayer3=True, numFiltersConv3=512, filterLenConv3=2, dilRate3=2, maxPool3=3,
...
class CharCNN(BasicModule):
    def __init__(self, pooltype = 'maxpool', globalpoolsize=128,
                    ...
                    isLayer2=True, numFiltersConv2=256, filterLenConv2=2, dilRate2=1, maxPool2=3,
                    isLayer3=True, numFiltersConv3=512, filterLenConv3=2, dilRate3=1, maxPool3=3):
...
def visualize_roc_curves(target, prediction,
    ...
    style : str, optional
        Default is "seaborn-v0_8-colorblind". Specify a style available in
